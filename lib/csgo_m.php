...
echo '" width="30"  class="logoTeam1-img"></div><div class = "betTeam1"><p style="margin-top:10px;">10000</p></div><div class = "timeinfo">'.date('d-m-Y H:i',$row['dateTime']).'<br>'.$row['format'];
