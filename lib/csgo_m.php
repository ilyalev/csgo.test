...
echo '" width="30"  class="logoTeam1-img"></div><div class = "betTeam1"><button class="btn-bet" id ="bet-sideA" data-toggle="modal" data-target="#betModal">10000</button></div><div class = "timeinfo">'.date('d-m-Y H:i',$row['dateTime']).'<br>'.$row['format'];
echo '</div><div class = "betTeam2"><button  class= "btn-bet" id ="bet-sideB" data-toggle="modal" data-target="#betModal">10000</button></div><div class ="logoTeam2"><img src="'.$row['team2Logo'];
echo '" width="30" class="logoTeam2-img"></div><div class ="nameTeam2"><p class="pTeam2">'.$row['team2Name'];
