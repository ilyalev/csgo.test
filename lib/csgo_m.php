...
echo '" class="logoTeam1-img"></div><div class = "betTeam1"><button class="btn-bet" id ="bet-sideA" data-toggle="modal" data-target="#betModal">10000</button></div><div class = "timeinfo">'.date('d-m-Y H:i',$row['dateTime']).'<br>'.$row['format'];
